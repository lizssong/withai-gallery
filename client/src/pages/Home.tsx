    ...
    <div className="min-h-screen ink-bg overflow-hidden relative">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4"
        ...
        <div className="absolute left-1/2 -translate-x-1/2">
          <span className="gallery-title italic text-sm"
      ...
      {phase === "invitation" && (
        <div className="min-h-screen flex flex-col items-center justify-center pt-20 pb-12 px-4">
          ...
          {/* 초대장 카드 */}
          <div
            className="parchment-card rounded-sm w-full max-w-md mx-auto px-6 sm:px-8 py-8 sm:py-10 relative fade-in-up fade-in-delay-2"
            style={{ maxWidth: "420px" }}
          >
            {/* 씨루 스탬프 */}
            <div className="flex justify-center -mt-14 mb-5">
              <div
                className="vermillion-seal w-16 h-16 rounded-full flex items-center justify-center"
            ...
            <div className="w-full lg:w-3/5 max-w-2xl">
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, rgba(28,28,46,0.7) 0%, transparent 100%)",
                  }}
                />
                {/* 작품 번호 오버레이 */}
      ...
      {phase === "epilogue" && (
        <div className="min-h-screen flex flex-col items-center justify-center pt-20 pb-12 px-4">
          ...
          <div
            className="parchment-card rounded-sm w-full max-w-lg mx-auto px-8 py-10 fade-in-up fade-in-delay-2"
          >
            {/* 씰 */}
            ...
            <div className="space-y-2 mb-6">
              {[
                {
                  label: "강의 문의하기",
                  sub: "생성형 AI · 캔바 · 캐릭터 이모티콘 디자인",
                  href: "#",
                },
                {
                  label: "크리메타쏭 채널",
                  sub: "AI 아트 & 캐릭터 디자인 콘텐츠",
                  href: "#",
                },
                {
                  label: "다음 전시회 소식",
                  sub: "리즈 · 요코 · 조코의 새로운 이야기",
                  href: "#",
                },
              ].map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className="flex items-start justify-between p-3 transition-all duration-200 hover:opacity-80 group"
                  style={{
