...
## 전시 홍보 콘텐츠 확장 (2026-08-13)
- [x] 송민경·신성희·황인진·박유영·장시경·진소령·김성아 작가별 대표 작품 1점씩을 포함한 확장 홍보기사 작성
- [x] 작가별 작품 1점씩 총 7점을 한 장에 구성한 전시 프레임 콜라주 홍보 이미지 제작

## 모바일 BGM 제어 근본 수정 (2026-08-13)
- [x] GalleryLayout BgmProvider — Web Audio/GainNode 기반으로 모바일 슬라이더·음소거 상태를 단일 출력 경로에 연결
- [x] 모바일 실환경에서 슬라이더·음소거 조작 시 실제 BGM 출력이 즉시 변하는지 통합 검증
- [x] 모바일 BGM 컨트롤의 패널 열기·슬라이더 드래그·음소거 토글 터치 상호작용 회귀 검증

## 모바일 BGM 재생 복구 (2026-08-13)
- [x] iOS 자동재생 정책과 충돌하지 않도록 모바일 BGM 재생 시작 흐름 복구
- [x] 모바일에서 BGM 재생·음량 조절·음소거를 분리 검증

## 전시회 공개 등록·홍보 채널 조사 (2026-08-13)
- [x] 온라인 AI 아트 전시회에 적합한 공개 등록 플랫폼과 커뮤니티 채널 조사
- [x] 채널별 우선순위와 등록용 콘텐츠 구성 제안
...
- [x] withai-gallery 저장소를 공개(Public)로 전환하고 비로그인 접근 확인
- [x] 사용자 브라우저의 공개 저장소 404 접근 오류 원인 확인 및 해결
- [x] GitHub Pages 공유 주소에서 온라인 갤러리로 연결되는 전시 소개 페이지 구성·배포 및 저장소 홈페이지 링크 연결
